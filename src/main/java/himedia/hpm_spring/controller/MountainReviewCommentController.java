...
import himedia.hpm_spring.service.MountainReviewCommentService;
...
public class MountainReviewCommentController {
		...
		public ResponseEntity<MountainReviewCommentVo> createComment(@PathVariable Long mReviewId, @RequestBody MountainReviewCommentVo comment) {
		    ...
		    // 커뮤니티 ID 설정
		    comment.setReviewsId(mReviewId);
		...
		// POST : /api/mountain-reviews/{mReviewId}/comments/{commentId}/replies -> 대댓글 생성
		@PostMapping("/{mReviewId}/comments/{commentId}/replies")
		public ResponseEntity<MountainReviewCommentVo> createReply(
		        @PathVariable Long mReviewId,
		        @PathVariable Long commentId,
		        @RequestBody MountainReviewCommentVo reply) {
		    
		    reply.setReviewsId(mReviewId);
		...
		public ResponseEntity<MountainReviewCommentVo> updateReply(
